<x-layout title="Nova música">
    <div class="max-w-2xl mx-auto mt-6">
        <div class="card bg-base-200 shadow-xl border border-base-300">
            <div class="card-body">
                <div class="mb-4">
                    <h2 class="card-title text-2xl font-bold">Novo registro de música</h2>
                    <p class="text-sm">Coloque aqui as informações da música da maneira que você aprendeu.</p>
                </div>
